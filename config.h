...
static const char *fonts[]          = { "JetBrains Mono:size=12:antialias=true:hinting=true" };
static const char dmenufont[]       = "JetBrains Mono:size=12:antialias=true:hinting=true";
...
/* tagging */
static const char *tags[] = { "cmd", "web", "dev", "chat", "gen" };
static const char *alttags[] = { "[cmd]", "[web]", "[dev]", "[chat]", "[gen]"};
